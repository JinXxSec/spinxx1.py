...
def usage():
	...
	print 'Usage: Jinxx (url)'
	print 'Example: Jinxx.py http://fuckingURLHEREDAMNNIT'
	print "\a"
print \
"""
 HI LOOOOOOOOOOOL 
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print "----->>> Spinxx attack started Sended <<<-----"
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Starting the Spinxx Smacking The Fucking Server Massive Revolt DDoS Tool"
		print "Spinxx_Sec"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
